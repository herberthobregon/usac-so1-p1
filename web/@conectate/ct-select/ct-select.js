 ...
 */
let CtSelect = class CtSelect extends CtLit {
    constructor() {
        super();
        this.disabled = false;
        this.raw_placeholder = '';
        this.ttl = '';
    ...
    async showDialog() {
        ...
        if (this.renderItem)
            ctSelect.dialog.renderItem = this.renderItem;
...
], CtSelect.prototype, "disabled", void 0);
__decorate([
    property({ type: String })
], CtSelect.prototype, "raw_placeholder", void 0);
CtSelect = __decorate([
    customElement('ct-select')
], CtSelect);
export { CtSelect };
//# sourceMappingURL=ct-select.js.map