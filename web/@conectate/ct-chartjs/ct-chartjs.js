...
export default class CtChartJS extends CtLit {
    ...
    async init() {
        ...
        if ((((_a = data.labels) === null || _a === void 0 ? void 0 : _a.length) || 1) > 6 && this.autoadjust) {
            this.y_ = 500;
        }
        if ((((_b = data.labels) === null || _b === void 0 ? void 0 : _b.length) || 1) > 15 && this.autoadjust) {
            console.log(options);
            this.y_ = 600;
        }
        ...
        this.chart = new Chart(this.$.canvas, {
            type: this.type,
            data: data,
            options: Object.assign(Object.assign({}, options), { responsive: true, maintainAspectRatio: false })
        });
...
], CtChartJS.prototype, "delay", void 0);
__decorate([
...
//# sourceMappingURL=ct-chartjs.js.map