...
import { C2Regexp, EvaluateParams } from './path_to_regexp';
/**
 ...
 */
let CtRouter = class CtRouter extends LitElement {
    constructor() {
        super();
        this.$ = {};
        this._routes = {};
    ...
    _pathChanged(path) {
        ...
        if (patternMatched && routes[patternMatched]) {
            ...
            if (routes[patternMatched].title()) {
                document.title = routes[patternMatched].title();
            }
        }
    }
    fire(name, value) {
...
export { CtRouter };
export function href(path, name = document.title) {
...
//# sourceMappingURL=ct-router.js.map